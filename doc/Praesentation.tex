...
% TODO: Ist das Beispiel brauchbar?
\subsection{Grafisches Beispiel: Ungünstige Parameter}
\begin{frame}
    \frametitle{Grafisches Beispiel: Ungünstige Parameter}
    \includegraphics<1>[trim=25 0 25 0, clip, width=\textwidth]{kaputt/000}
    \includegraphics<2>[trim=25 0 25 0, clip, width=\textwidth]{kaputt/001}
    \includegraphics<3>[trim=25 0 25 0, clip, width=\textwidth]{kaputt/002}
    \includegraphics<4>[trim=25 0 25 0, clip, width=\textwidth]{kaputt/003}
    \includegraphics<5>[trim=25 0 25 0, clip, width=\textwidth]{kaputt/004}
    \includegraphics<6>[trim=25 0 25 0, clip, width=\textwidth]{kaputt/005}
    \includegraphics<7>[trim=25 0 25 0, clip, width=\textwidth]{kaputt/006}
    \includegraphics<8>[trim=25 0 25 0, clip, width=\textwidth]{kaputt/007}
    \includegraphics<9>[trim=25 0 25 0, clip, width=\textwidth]{kaputt/008}
    \includegraphics<10>[trim=25 0 25 0, clip, width=\textwidth]{kaputt/009}
    \includegraphics<11>[trim=25 0 25 0, clip, width=\textwidth]{kaputt/010}
    \includegraphics<12>[trim=25 0 25 0, clip, width=\textwidth]{kaputt/011}
    \includegraphics<13>[trim=25 0 25 0, clip, width=\textwidth]{kaputt/012}
    \includegraphics<14>[trim=25 0 25 0, clip, width=\textwidth]{kaputt/013}
\end{frame}
