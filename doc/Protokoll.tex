...
\begin{quote}
Alle Performance-Messungen wurden auf dem Rechner $i82sn03$ mit 4 OpenMP"-Threads durchgeführt. Für Zeitmessungen wurde die C++ Chrono-API verwendet.
\end{quote}
...
\begin{figure}
    ...
    \caption{Maximaler Approximationsfehlers nach jedem Iterationsschritt. //TODO Welches n wurde hier verwendet?}
    \label{fig:fehler}
\end{figure}
